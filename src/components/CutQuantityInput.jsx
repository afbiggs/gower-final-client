...
function CutQuantityInput({ isLocked, onCutQuantityChange }) {
  ...
  const handleKeypadSubmit = (value) => {
    ...
    if (onCutQuantityChange) {  // ✅ Prevents crashing if prop is missing
        onCutQuantityChange(value); 
    } else {
        console.error("onCutQuantityChange is undefined!");
    }
...
export default CutQuantityInput;
